	              		...
	              		formatter:function(value,row,index){
	              			...
	              			if(row.t_disable == 0){
		              			...
		              			if(row.t_certification_type == 0){
		              				obj+= '<a class="btn btn-default" href="javascript:on_click_verify_success('+row.t_id+')" style="height: 25px;line-height: 0.5;background-color: #87CEFA;">审核通过</a>&nbsp;&nbsp;';
		              				obj+= '<a class="btn btn-default" href="javascript:on_click_verify_fail('+row.t_id+')" style="height: 25px;line-height: 0.5;background-color: #87CEFA;">审核失败</a>&nbsp;&nbsp;';
		              			}
	              			
	              				obj+= '<a class="btn btn-default" href="javascript:on_click_disable('+row.t_id+')" style="height: 25px;line-height: 0.5;background-color: #87CEFA;">禁用</a>&nbsp;&nbsp;';
	              			}
